...
:------------:|---------|-
NGiИX         | 1.17.7  | [![](https://repology.org/badge/latest-versions/nginx.svg)](//nginx.org/en/CHANGES)
...
Package                        | Version | Latest available
:-----------------------------:|---------|-
NJS                            | 0.3.7   | [![](https://img.shields.io/github/tag/nginx/njs.svg)](//nginx.org/en/docs/njs/changes.html)
