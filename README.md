...
:------:|---------|-
NGiИX   | 1.15.4  | [![](https://repology.org/badge/latest-versions/nginx.svg)](//nginx.org/en/CHANGES)
...
OpenSSL | 1.1.1   | [![](https://repology.org/badge/latest-versions/openssl.svg)](//www.openssl.org/news/changelog.html)
